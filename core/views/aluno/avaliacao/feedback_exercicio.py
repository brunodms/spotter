...
class AlunoFeedbackExercicioView(AlunoRequiredMixin, CreateView):
    model = Feedback
    form_class = FeedbackForm
    template_name = "core/aluno/feedback_exercicio.html"
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        self.exercicio = get_exercicio_do_aluno(
            request.user,
            kwargs["plano_pk"],
            kwargs["sessao_pk"],
            kwargs["exercicio_pk"],
